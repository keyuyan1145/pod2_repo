...
print('This is a list of dictionaries with strings as key value as types. I know this because there is a group of items separated by commas, and all contained within square brackets. ')
