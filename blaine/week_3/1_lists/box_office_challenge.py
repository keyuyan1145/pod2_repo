...
#-------------- USE SPLIT METHOD TO SPLIT movie_str at every comma
remaining_50_list = movies_str.split(",")
# print the new variable list
...
# ---------COMBINE BOTH LISTS TO CREATE NEW LIST
...
# -------- JOIN THE ARRAY WITH A ", " SEPERATOR
