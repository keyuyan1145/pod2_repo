...
print(remaining_50_list)
# if 'The Matrix' not in remaining_50_list:#checking if the matrix is still there
    # print('The matrix is not there')

# print(remaining_50_list.index('The Matrix'))# will also find if the item is there and what the index is
