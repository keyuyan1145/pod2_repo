...
favorite_things=[]
for day in days:
    thing_to_do=input(f'What is your favorite thing to do on {day}? ')
    favorite_things.append(thing_to_do)
...
for d in range(len(days)):
    print(f'On {days[d]} your favorite thing to do is {favorite_things[d]}')
...
num_times=int(input('How many times would you like to be wished Happy Birthday?'))
