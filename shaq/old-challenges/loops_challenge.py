...
activities = []
for day in days:
    activitity = input(f"what is your favorite thing on {day}? ")
    activities.append(activitity)
...
for day in days:
    temperature = int(input(f"what is the temperaturs on {day}?"))
    if temperature < 50:
        print("wear a jacket")
...
num_wishes = int(input("How many time would you like to be wished happy birtday"))
