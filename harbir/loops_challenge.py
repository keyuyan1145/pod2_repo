...
for day in days:
    print(day)
# Created a loop statement inorder to turn the elements of the days variable into seperate variables for each day.
...
# day_fav = input(f'What is your favorite thing to do on {day}?')
# This command will ask the user their favorite activity for each day of the week and save it as a seperate variable.
...
# This loop command will append the input of the user to a new list.
...
# This loop range command will out the favorite activites with each element in the days variable.
...
# It is a good idea to read through the whole assignment to figure out the end goal. It is also important to break down the steps inorder to achieve the goal and get the end result.

# Try to break down the steps required for this second loop challenge.
# For this assignment we need to capture the users favorite activity for each day of the week and output a list displaying their favorite activity for each day of the week.
# 1) Create a loop to break down the days list into independent variables for each day of the week named day.
# 2) Create a f string that askes the user their favorite activity for the day.
# 3) Save the users input into a new seperate variable name fav_act.
# 4) Create a new loop that prints out the days list and fav-act list into a output f string displaying the users favorite activites for each day of the week.
...
num_birthday_wishes = int(input(f'How many times would you like to be wished Happy Birthday?'))
for i in range(num_birthday_wishes):
