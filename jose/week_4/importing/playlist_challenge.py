...
print('Question 5')
add_song(my_playlist, {'artist': 'Adele', 'title': 'Easy On Me'})
add_song(my_playlist, {'artist': 'Doja Cat', 'title': 'You Right'})
...
mean_monthly_plays = np.mean(monthly_plays)
print('The mean for monthly plays is', mean_monthly_plays)
