...
# The type function is used to figure out the type a variable is.
print(type(books))
...
# This variable is a list of dictionaries with the name, author and author and brief description of the book. You can tell what the variable includes by the seperators such as (), [], {}
# 2.1
